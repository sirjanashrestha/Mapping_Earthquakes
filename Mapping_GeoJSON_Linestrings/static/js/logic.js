...
let light = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/light-v10/tiles/{z}/{x}/{y}?access_token={accessToken}', { //API URL with reference to accessToken
...
let torontoData = "https://raw.githubusercontent.com/sirjanashrestha/Mapping_Earthquakes/main/torontoRoutes.json";
