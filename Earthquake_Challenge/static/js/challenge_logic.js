...
//Add third map style as title layer object
...
let tectnonicPlates=new L.LayerGroup();
...
let overlays = {
  ...
  "Tectonic Plates":tectnonicPlates,
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  //Access the tectonic plate GeoJSON data
  ...
  d3.json(tectonicplateData).then(function(data){
    ...
    L.geoJSON(data,{
      style:myStyle
    }).addTo(tectnonicPlates);
    tectnonicPlates.addTo(map);  
  });
});