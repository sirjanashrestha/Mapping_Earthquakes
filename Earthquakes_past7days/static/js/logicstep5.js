...
//Define overlay object which will be visible all the time
let overlays={
...
d3.json(earthquakeData).then(function(data){
    ...
    //Add the details for legend
    legend.onAdd=function(){ //legend.onAdd adds legend to map
      let div = L.DomUtil.create("div", "info legend"); //legend will be added to div element on index.html
      //using DomUtil utility function
      ...
      //Loop through colors to generate a lavel with colored square for each interval
      for (var i=0;i<magnitudes.length;i++){
        console.log(colors[i]);
        div.innerHTML+= //add colors to html using div.innerHTML
